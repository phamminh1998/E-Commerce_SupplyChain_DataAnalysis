...
-- Create the raw_data table with modified column names
CREATE TABLE IF NOT EXISTS raw_data (
    type VARCHAR(50),
    days_for_shipping_real INT,
    days_for_shipment_scheduled INT,
    benefit_per_order DECIMAL(18, 10), -- Adjusted precision for larger decimal values
    sales_per_customer DECIMAL(18, 10), -- Adjusted precision for larger decimal values
    ...
    latitude DECIMAL(18, 10), -- Adjusted precision for latitude
    longitude DECIMAL(18, 10), -- Adjusted precision for longitude
    market VARCHAR(50),
    ...
    order_item_discount DECIMAL(18, 10), -- Adjusted precision for larger decimal values
    order_item_discount_rate DECIMAL(18, 10), -- Adjusted precision for larger decimal values
    order_item_id INT,
    order_item_product_price DECIMAL(18, 10), -- Adjusted precision for larger decimal values
    order_item_profit_ratio DECIMAL(18, 10), -- Adjusted precision for larger decimal values
    order_item_quantity INT,
    sales DECIMAL(18, 10), -- Adjusted precision for larger decimal values
    order_item_total DECIMAL(18, 10), -- Adjusted precision for larger decimal values
    order_profit_per_order DECIMAL(18, 10), -- Adjusted precision for larger decimal values
    ...
    product_price DECIMAL(18, 10), -- Adjusted precision for larger decimal values
...
USE dataco;
SELECT DISTINCT shipping_mode FROM interim_data; 
-- Find rows with non-ASCII characters in the order_city column
SELECT order_item_id , product_card_id 
FROM interim_data
WHERE order_item_id != product_card_id ;
